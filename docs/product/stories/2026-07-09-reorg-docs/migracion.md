...
| `CLAUDE.md` punteros (VISION/METODOLOGIA/docs/architecture/knowledge/arch/UX + reglas git/§10) | se conservan → `CLAUDE-nuevo.md` (ya draft) |
...
6. **Actualizar `MEMORY.md`** (índice de memoria): apuntar el patrón nuevo; y `docs/architecture/CADENCE.md`
...
- **Punteros rotos:** otros docs citan `LEDGER.md#HS-NN` en prosa. Mitigación: `grep -rn
  "HS-[0-9]" *.md arch/ docs/architecture/knowledge/ historias/` antes del paso 3; re-apuntar a `ledger/HS-NN.md`.
