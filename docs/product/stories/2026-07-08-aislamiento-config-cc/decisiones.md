...
settings) se agregan a `docs/architecture/boundaries/superficie-local-confinada.md` (ya vigente desde
...
`docs/architecture/knowledge/` por tema, no por PR). `permisos-derivan-del-rol` se mantiene sin tocar — ese
