...
4. **Colisión de elemento «hooks»**: el parser del ruleset usa basename
   (parser.go:105) — docs/architecture/knowledge/elements/hooks.md (12 checks CC) y
   docs/architecture/conventions/hooks.md (3 checks lefthook) se funden en un elemento de 15;
