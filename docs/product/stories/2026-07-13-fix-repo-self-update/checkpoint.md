---
story_id: 2026-07-13-fix-repo-self-update
state: developed
module: fix
...
# Estado inferido de: PARIDAD con gate 🧑‍⚖ pendiente: «🧑‍⚖️ **Gate humano** — pendiente: abrir la app Tauri en una…»
...
# 2026-07-13-fix-repo-self-update
