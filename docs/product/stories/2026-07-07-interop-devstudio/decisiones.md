...
- `docs/architecture/contracts/schema/graph.l0.schema.json` — `nombre`/`descripcion` + `spine.categorias`.
- `docs/architecture/contracts/nomenclatura-arnes.md` — v1.1 (detector lock · nombre canónico · categorias).
