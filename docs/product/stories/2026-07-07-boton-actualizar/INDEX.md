...
| OpenAPI | `docs/architecture/contracts/api/openapi.yaml` | `+ /version` · `+ /self-update` · bump `0.3.0-hs11` |
| go-arch-lint | `docs/architecture/fitness/.go-arch-lint.yml` | componente `selfupdate: in: internal/adapters/selfupdate/**` mayDependOn `[domain, ports]`; `cmd` lo suma |
