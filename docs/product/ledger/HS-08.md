...
`docs/architecture/knowledge/` + `arch/` = **235 checks a datos**; `ConformancePort` + adapters por mecanismo (arch-test ·
...
§3/§5/§8 · CLAUDE Estado · INDEX de docs/architecture/knowledge/arch · re-atribución DAOP-A2/A7 · 4 capacidades) en la misma ola.
