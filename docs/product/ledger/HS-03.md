...
firmadas + inventario + backlog) y [`../../process/metodologia.md`](../../process/metodologia.md) (reglas de negocio:
ArnesIA dueño de crear Y mantener · fábrica de cajas · contrato de caja §3 · reglas de honestidad).
Base de evidencia = árbol [`docs/architecture/knowledge/`](./docs/architecture/knowledge/INDEX.md) (11 nodos · **122 checks** al corte).
