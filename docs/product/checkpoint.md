...
- **ruleset `--todo`:** `323 checks · pass 81 · fail 0 · error 0 · deferred 242 · n/a 0` (medido 2026-07-26, `go run ./cmd/arnesia conformance --todo`)
...
- **capabilities (SSoT):** 139 — 85 vivo · 39 vivo·nc · 13 parcial · 2 stub · **cobertura 100%** (0 huérfanos, 0 punteros colgantes)
<!--/stats-->
