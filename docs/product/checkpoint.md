...
- **Programa «Portafolio · ciclo de vida del arnés» — modelo FIRMADO 🧑‍⚖️ (HS-22, 2026-07-13); Slice 0
  CONSTRUIDO + FIRMADO 🧑‍⚖️ (HS-23, 2026-07-13).**
  ...
  **Hand-off:** Fable 5 (arquitecto) planificó → Sonnet 5 (constructor) ejecutó T1-T9. Gate humano firmado —
  **Slice 1 «FE» desbloqueado**, ver «Retomar aquí».
...
- **Retomar aquí:** **Slice 0 «Cimientos» CONSTRUIDO + FIRMADO 🧑‍⚖️ (2026-07-13)** en
  ...
  en `decisiones.md`). Gate humano firmado (8 puntos del goal §0 + 5 desviaciones aceptadas,
  `ledger/HS-23.md`). **Próximo: Slice 1 «FE Portafolio»** (BACKLOG item 1, desbloqueado) — arranca
  releyendo `mockups/INDEX.md` (línea base = superset del mockup v2 aprobado) antes de tocar UI.
...
- **ruleset `--todo`:** `253 checks · pass 42 · fail 0 · error 0 · deferred 211 · n/a 0` (medido 2026-07-14, `go run ./cmd/arnesia conformance --todo`)
...
- **capabilities (SSoT):** 92 — 44 vivo · 40 vivo·nc · 1 parcial · 7 stub · **cobertura 100%** (0 huérfanos, 0 punteros colgantes)
<!--/stats-->
