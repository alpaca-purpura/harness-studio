...
- **ruleset `--todo`:** `323 checks · pass 91 · fail 0 · error 0 · deferred 232 · n/a 0` (medido 2026-07-26, `go run ./cmd/arnesia conformance --todo`)
...
- **capabilities (SSoT):** 144 — 94 vivo · 35 vivo·nc · 13 parcial · 2 stub · **cobertura 100%** (0 huérfanos, 0 punteros colgantes)
<!--/stats-->
