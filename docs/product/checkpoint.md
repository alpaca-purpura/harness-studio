...
- **ruleset `--todo`:** `330 checks · pass 97 · fail 0 · error 0 · deferred 233 · n/a 0` (medido 2026-07-30, `go run ./cmd/arnesia conformance --todo`)
...
- **capabilities (SSoT):** 152 — 104 vivo · 32 vivo·nc · 15 parcial · 1 stub · **cobertura 100%** (0 huérfanos, 0 punteros colgantes)
<!--/stats-->
