...
> METODOLOGIA §3 (contrato fusionado) + §8 (doctrina de proceso) · `docs/architecture/knowledge/elements/harness-profile.md`
> (nodo 12) + checks del firewall en skills/rules/subagents · `docs/architecture/boundaries/{orquestacion-determinista-
...
Dictamen por mecanismo (fuente: docs/architecture/knowledge/ verificado contra docs CC v2.1.x):
...
7. **docs/architecture/knowledge/ árbol VIVO con cadencia semanal** anclado a Anthropic/expertos + 122 checks como
...
**Nodo nuevo en `docs/architecture/knowledge/` (el mayor aporte estructural):**
...
- Estudio 5-frentes (subagentes, 2026-07-05): constitución/VISION · metodología/contrato ·
  docs/architecture/knowledge/CC-native · arch/conductor/runtime · estrategia/MOF/orgs. Convergencia fuerte en las 3
  tesis (§0). Detalle de cada frente disponible en el hilo de la sesión.
- Nuestras capas: `VISION.md` · `METODOLOGIA.md` · `docs/architecture/knowledge/` (11 nodos, 122 checks) · `arch/`
