# docs/architecture/conventions/ — convenciones de código as code de ArnesIA
...
[`./CADENCE.md`](./CADENCE.md). El runner futuro **`arnesia conformance`** corre `docs/architecture/knowledge/` + `arch/`
(boundaries + fitness) + `docs/architecture/conventions/` en un solo reporte.
