...
> [`docs/architecture/knowledge/`](./INDEX.md) al día sin romper la forma en que trabajamos. Las *reglas* del
...
```
ACTUALIZACIÓN SEMANAL — árbol de conocimiento de ArnesIA (docs/architecture/knowledge/)

Corres la cadencia que mantiene docs/architecture/knowledge/ (el estándar vivo) al día con el ecosistema
Claude Code / arneses. LEE PRIMERO docs/architecture/knowledge/CADENCE.md (reglas) y docs/architecture/knowledge/WEEKLY-UPDATE.md
...
docs/architecture/knowledge/_inbox/<AÑO>-W<semana>.md + UN commit.
```
...
### 7 · Reporte + commit
Escribir `docs/architecture/knowledge/_inbox/<AÑO>-W<ww>.md` (plantilla abajo). **Un solo commit** por corrida,
