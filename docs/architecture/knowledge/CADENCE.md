...
> ArnesIA carga para pintar puntos de mejora en el mapa. Norte: [`../../product/vision.md`](../../product/vision.md)
> (principio 8 «estándar propio», principio 11 «economía de contexto medible») y
> [`../../process/metodologia.md`](../../process/metodologia.md) (doctrina de negocio, que **deriva** de este árbol).
...
7. **Propagar.** Si el cambio toca reglas de negocio, actualizar [`../../process/metodologia.md`](../../process/metodologia.md);
   si toca la UX (un check nuevo que el mapa debe pintar), registrarlo en [`../../product/ux.md`](../../product/ux.md).
