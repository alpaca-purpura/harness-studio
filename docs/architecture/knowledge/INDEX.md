# docs/architecture/knowledge/ — árbol de conocimiento vivo de ArnesIA
...
> [`../historias/2026-07-05-doctrina-propia-v1-adaptacion-daop.md`](../../product/research/2026-07-05-doctrina-propia-v1-adaptacion-daop.md).

## Cómo se relaciona con el resto del repo

- [`../../product/vision.md`](../../product/vision.md) — constitución (11 principios + anatomía A1–A7). El **norte**.
- [`../../process/metodologia.md`](../../process/metodologia.md) — reglas de negocio / doctrina operativa. **Deriva**
  de este árbol: «qué debe tener cada componente» (§2–3) se apoya en los nodos de aquí.
- [`../../product/ux.md`](../../product/ux.md) — la UX que consume los checks (los puntos de mejora que el mapa pinta
  salen de los `Checklist evaluable` de cada nodo).
- [`../historias/2026-07-04-salud-trazas-edicion.md`](../../product/research/2026-07-04-salud-trazas-edicion.md)
