...
- **`historias/2026-07-09-reorg-docs/`** — reorg de docs: árbol de 4 ejes + CAPABILITIES SSoT +
  doctrina de trazado código→capability. → estado/próximo-paso en su `INDEX.md`.
- Paquetes con **gate humano de PARIDAD pendiente** (código listo, falta firma) → `BACKLOG.md`.
