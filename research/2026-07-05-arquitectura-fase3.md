...
> Es la **evidencia L1** que respaldan los boundary nodes de [`../arch/`](../arch/INDEX.md).
...
**Dos correcciones load-bearing al nodo [`headless-sdk`](../knowledge/elements/headless-sdk.md):**
...
**Árbol propuesto (espeja `knowledge/`):** ver [`../arch/INDEX.md`](../arch/INDEX.md). Cada
