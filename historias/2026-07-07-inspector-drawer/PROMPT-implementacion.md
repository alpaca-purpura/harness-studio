...
5. Arquitectura que RIGE: `arch/INDEX.md` + boundaries `fe-taxonomia-componentes`
   ...
   `arch/conventions/` (estilo Go/TS, commits) · `arch/contracts/` (OpenAPI + schemas)
...
ruta en router.go + **changelog OpenAPI** (`arch/contracts/`), lectura CONFINADA al dir
