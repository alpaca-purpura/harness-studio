...
`arch/boundaries/superficie-local-confinada.md`: nueva versión (bump de version en
...
nuevo en el nodo. `knowledge/elements/mcp.md`: nota en cambios recientes o changelog —
