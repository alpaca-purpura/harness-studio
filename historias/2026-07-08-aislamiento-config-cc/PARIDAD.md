...
`arch/boundaries/superficie-local-confinada.md` · `arch/fitness/
hs17_config_source_test.go` (nuevo) · `knowledge/elements/mcp.md` · `CLAUDE.md`.
...
(`arch/conventions/hooks.md→git-hooks.md`, 0 cambio de contenido) viajó en el commit
