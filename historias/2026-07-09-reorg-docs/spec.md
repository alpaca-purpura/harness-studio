...
- **RF-177** Toda hoja lleva cabecera de cita: `> vig: activo | archivado · revisar: AAAA-MM-DD`.
  ...
  - `revisar` vencido → la hoja se re-valida o se archiva (mecanismo en `arch/CADENCE.md`,
    igual que knowledge/arch). Las fichas `ledger/HS-NN.md` nacen `archivado` (son historia).
